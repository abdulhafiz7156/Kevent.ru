...
$(document).ready(function() {
	...
	window.agree_cookie = window.agree_cookie.length;

	if(!window.agree_cookie){
		$('.cookie-block').fadeIn(400).addClass('loaded');
	}

	$('.js-close-cookie').click(function () {
		$('.cookie-block').fadeOut(400).removeClass('loaded');
	});

	$('.js-agree-cookie').click(function () {
		$('.cookie-block').fadeOut(400).removeClass('loaded');
	...
	if( $(window).width() > 780){
		...
		/*if(document.querySelector('.socials-wrapper').classList.contains('socials-hiding') == true){

		document.querySelector('.socials-wrapper').classList.remove('socials-hiding');
		document.querySelector('.logo-container .logo').classList.remove('logo-scale');
		document.querySelector('.icon-hand').classList.remove('hand-rotate');
		document.querySelector('.phone-top').classList.remove('phone-top-hiding');
		document.querySelector('.button-menu').classList.remove('button-menu-scale');
		document.querySelector('.cookie-block').classList.remove('coockie-scale');
		document.querySelector('.scroll-down').classList.remove('scroll-down-scale');
	    } */
	...
	function initFullpage () {
		$('#fullpage').fullpage({
			...
			onLeave: function (index, nextIndex, direction) {
				...
				if ( nextIndex === 7 ){
					$('.socials').addClass('socials-hidden');
					$('.button-menu').addClass('move-top');
				}
				else{
					$('.socials').removeClass('socials-hidden');
